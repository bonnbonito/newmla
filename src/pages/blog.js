                ...
                {blogs.map( ({node}) => {                        
                    ...
                    <div className="col-md-3" key={node.id}>
                        ...
                        <div className="social-icon-container">                        
                            <a href={`https://twitter.com/intent/tweet?url=${node.link}&text=Title${node.title}`}><FontAwesomeIcon icon={faFacebookF} /></a>
                            <a href={`https://www.facebook.com/sharer/sharer.php?u=${node.link}`}><FontAwesomeIcon icon={faTwitter} /></a>                            
                            <a href={node.link}><FontAwesomeIcon icon={faEnvelope} /></a>						
                        </div>
